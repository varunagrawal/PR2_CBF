...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle n;
    ros::ServiceClient client = n.serviceClient<moveit_msgs::GetPositionFK>("get_pr2_forward_kinematics");
    moveit_msgs::GetPositionFK srv;

    srv.request.robot_state.joint_state.name = {"r_shoulder_pan_joint", "r_shoulder_lift_joint", "r_upper_arm_roll_joint", "r_elbow_flex_joint", "r_forearm_roll_joint", "r_wrist_flex_joint", "r_wrist_roll_joint"};
    srv.request.robot_state.joint_state.position = {-0.787064843322, -4.22593924299e-07, -1.75779266698e-07, -0.149996749925, 2.28851725126e-07, -0.100002260175, 1.70990356096e-07};
    srv.request.robot_state.joint_state.velocity.resize(7, 0.0);
    srv.request.robot_state.joint_state.effort.resize(7, 0.0);
